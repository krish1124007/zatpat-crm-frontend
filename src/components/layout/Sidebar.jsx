...
const NAV = [
  ...
  { to: '/cases/status/Ready Login', label: 'Ready Login', icon: '🔷', statusDot: 'Ready Login' },
  { to: '/cases/status/Bank finalized', label: 'Bank finalized', icon: '🔵', statusDot: 'Bank finalized' },
  { to: '/cases/status/Under Bank Workout', label: 'Under Bank Workout', icon: '🟣', statusDot: 'Under Bank Workout' },
  { to: '/cases/status/Under Login Query', label: 'Under Login Query', icon: '🔹', statusDot: 'Under Login Query' },
  { to: '/cases/status/Login done - under process', label: 'Login done - under process', icon: '🟠', statusDot: 'Login done - under process' },
  ...
  { to: '/cases/status/Not interested', label: 'Not interested', icon: '⬜', statusDot: 'Not interested' },
